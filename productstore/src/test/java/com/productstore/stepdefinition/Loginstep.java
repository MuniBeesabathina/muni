...
//Fill the details	
	...
	public void the_user_login_using_and_with_valid_and_invalid_details(String username, String password)
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		Thread.sleep(4000);
		productlogin.loginDetails(username, password);
		Thread.sleep(4000);
		productlogin.screenShot("src/test/resources/screenshot/login.png");
	}
